  ...
  return (
    <div className="fixed top-0 z-50 flex items-center justify-between w-full h-20 border-b border-[#525658] bg-Grayscale-100 user-dropdown-container">
      ...
      >
        ...
        <button className="px-10 py-2.5 bg-[#21F5BE] text-Grayscale-90 font-['Pretendard'] font-bold w-[199px] h-[46px] rounded-md flex items-center justify-center" onClick={openFigmaAppOrWeb}>
            FIGMA PLUGIN
        </button>
